...
print(empty['C3'])
print(f'最小區域 {empty.dimensions}')
# 存取 E5 導致最小區域改變
empty['E5']
print(f'存取 E5 後的最小區域 {empty.calculate_dimension()}')

r_empty = load_workbook('Goods.xlsx', True)['Empty']
# 對於唯讀工作表，存取 E5 不會導致最小區域改變
r_empty['E5']
print(f'唯讀工作表存取 E5 後的最小區域 {r_empty.calculate_dimension()}')
